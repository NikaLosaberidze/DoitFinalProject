...
{
    internal class WithdrawLogger : ILogger
    {
        ...
        {
            string transaction = $"    \"{customer.Auto_ID}. მომხმარებელმა სახელად {customer} - გაანაღდა {aTMForm.WithdrawBox.Text} ლარით : {DateTime.Now} - ში. მისი მოქმედი ბალანსი შეადგენს {aTMForm.BalanceBox.Text} ლარს\"";
            ...
            aTMForm.TransactionsListAdd($"{customer.Auto_ID}. მომხმარებელმა სახელად {customer} - გაანაღდა {aTMForm.WithdrawBox.Text} ლარით : {DateTime.Now} - ში. მისი მოქმედი ბალანსი შეადგენს {aTMForm.BalanceBox.Text} ლარს");
            aTMForm.WithdrawBox.Text = "";
